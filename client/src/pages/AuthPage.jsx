...
const AuthPage = ({ onLoginSuccess }) => {
  ...
  const renderForm = () => {
    switch (activeForm) {
      ...
      case 'login':
      default:
        return <Login onSwitchForm={() => setActiveForm('register')} onLoginSuccess={handleLoginSuccess} />;
    }
  };
      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 shadow-2xl rounded-2xl overflow-hidden bg-white">
        <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-8 sm:p-12 flex-col justify-center items-center text-white hidden md:flex">
          <div className="text-center">
             <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-24 w-24 mx-auto mb-6 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                ...
                <button 
                  ...
                  className={`w-1/2 py-4 text-center font-semibold transition-colors duration-300 focus:outline-none ${
                    activeForm === 'login' 
                      ...
                      : 'text-gray-500 border-b-2 border-transparent hover:text-emerald-500 hover:border-gray-300'
                  }`}
                >
                  Login
                </button>
